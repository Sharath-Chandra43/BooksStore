    ...
    <>
      ...
      <div className="">
        <div className="text-center m-4 p-4">
          ...
          {cartItems.length === 0 && (
            <h1 className="text-red-700 font-bold">Your Cart Is Empty</h1>
          )}

          <div className="flex flex-wrap p-14">
            {cartItems.map((item, index) => (
              <div key={item.isbn13 || index} className="flex flex-col justify-between">
                  ...
                  <div className="">
                    ...
                    <div className="flex justify-end">
                      <img
                        ...
                        className="pl-77 cursor-pointer w-9 rounded-lg hover:bg-red-600 hover:text-black"
